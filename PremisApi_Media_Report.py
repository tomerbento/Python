...
Dim = '["timeInterval","placement","placementSize","browser","country","deviceType","domain","subId"]'

#set the metrics for the report
Metric =    '["id","name","placementImps","revenue","rpm","video_adserver_imps","video_adserver_rev","video_primis_rev","video_adserver_ecpm","pub_hb_attempts","pub_hb_fillrate","adserver_serving_fee"]'
...
while start_date <= end_date:
        ...
        while True  :
                        ...
                        if response.status_code==454 :
                            ...
                            FileName ='D:/DATA_LAKE_INGESTION_US/Primis/Media_Report/Primis_Media_Report_'+DateInterval+'.json' 
                            break
                        else:
